    ...
    switch (categoryLower) {
      case 'machine learning':
        return {
          ...
          barColor:
            'bg-gradient-to-r from-primary/75 via-primary/85 to-primary shadow-primary/30 dark:shadow-primary/40',
      ...
      case 'development':
        return {
          ...
          barColor:
            'bg-gradient-to-r from-secondary/75 via-secondary/85 to-secondary shadow-secondary/30 dark:shadow-secondary/40',
      ...
      case 'tools':
        return {
          ...
          barColor:
            'bg-gradient-to-r from-accent/75 via-accent/85 to-accent shadow-accent/30 dark:shadow-accent/50',
      ...
      case 'soft skills':
        return {
          ...
          barColor:
            'bg-gradient-to-r from-success/75 via-success/85 to-success shadow-success/30 dark:shadow-success/40',
  ...
  return (
    <div className="group">
      <div className="flex justify-between mb-2">
        <span className="text-sm font-medium text-foreground group-hover:scale-105 transition-transform duration-200">
          {skill.name}
        </span>
        <span
          className={`text-sm font-bold ${colors.textColor} group-hover:scale-110 transition-all duration-200`}
        >
          {skill.level}%
        </span>
      </div>
      <div
        className={`w-full rounded-full h-3 ${colors.bgColor} shadow-inner transition-all duration-300`}
      >
        <motion.div
