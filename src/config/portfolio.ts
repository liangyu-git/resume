...
export const projects: Project[] = [
  {
    ...
    description:
      'Advanced facial recognition system with 99.2% accuracy using deep learning and computer vision techniques.',
  ...
  },
  {
    ...
    description:
      'Real-time beauty enhancement filter using computer vision and AR technology for mobile applications.',
  ...
  },
  {
    ...
    description:
      'Scalable object detection API serving multiple models with real-time inference and batch processing.',
